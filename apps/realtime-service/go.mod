module github.com/wintkhantlin/toolydooly/realtime-service
...
require (
	...
	github.com/wintkhantlin/toolydooly/shared v0.0.0
...
replace github.com/wintkhantlin/toolydooly/shared => ../../packages/go-shared
